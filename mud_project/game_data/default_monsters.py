...
DEFAULT_MONSTER_TEMPLATES = {
    "training_dummy": {
        ...
        "faction_hits_on_kill": [], # No faction change for a dummy
        "xp_value": 0,
    ...
    "giant_rat": {
        ...
        "hp": 25, "max_hp": 25, "defense": 2, "attack_damage": "1d4", "attack_delay": 2.0, "natural_attack_bonus_damage": 1, # Added for its bite
        ...
        "faction_id": "Vermin",
        "faction_hits_on_kill": [ # Killing rats might slightly improve standing with town guards
            {"faction_id": "OakhavenCivilian", "amount": 1} 
        ],
        "xp_value": 10,
    ...
    "goblin_archer": {
        ...
        "faction_hits_on_kill": [
            ...
            {"faction_id": "OakhavenCivilian", "amount": 15}, # Good for Oakhaven
            {"faction_id": "ScaleScourgeClan", "amount": 5}  # Kobolds might like less goblins
        ],
        "xp_value": 20,
